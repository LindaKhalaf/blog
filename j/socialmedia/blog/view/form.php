<?php 
 ...
 ?>
<div id="color">
<div id="create_"><p>Create Blog Post</p></div><!--mah title -->

<center><form method="post" action="<?php echo $path . "/controler/create-post.php"; ?>"><!--connects this file to the file create-post.php -->
	<div id="title_">
